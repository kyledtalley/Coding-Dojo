	...
	return (
		<div className="details-container">
			<div className="edit-link-container">
				...
				<h1 className = "putShadowHere">Secret Recipe</h1>
			</div>
			<div className="dets">
				...
				<p id="ingredientOne">{recipe.ingredients?.ingredientOne}</p>

				<label htmlFor="ingredientTwo">Ingredient Two</label>
				<p id="ingredientTwo">{recipe.ingredients?.ingredientTwo}</p>

				<label htmlFor="ingredientThree">Ingredient Three</label>
				<p id="ingredientThree">{recipe.ingredients?.ingredientThree}</p>
