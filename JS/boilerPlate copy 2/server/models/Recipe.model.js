...
const RecipeSchema = new Schema(
	{
		...
		directions: {
			...
			maxlength: [
				75,
				"Directions length must be no longer than 75 characters long",
			],
		},
		ingredients: {
			ingredientOne: {
				...
				validate: {
					validator: function (ingredient) {
						return ingredient.length >= 2 || ingredient.length === 0
					},
					message:
				...
				maxlength: [
					75,
					"Ingredient One length must be 75 characters maximum",
				],
			},
			ingredientTwo: {
				type: String,
				...
				validate: {
					...
					message:
						"Ingredient Two length must be at least 2 characters long",
				},
				maxlength: [
					75,
					"Ingredient Two length must be 75 characters maximum",
				],
			},
			ingredientThree: {
				type: String,
				...
				validate: {
					...
					message:
						"Ingredient Three length must be at least 2 characters long",
				},
				maxlength: [
					75,
					"Ingredient Three length must be 75 characters maximum",
				],
			},
		},
	},
